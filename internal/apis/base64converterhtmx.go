...
// Base64ConverterHTMXInput is the request structure for the /api/base64converter endpoint.
...
// Base64ConverterHTMXOutput is the response structure for the /api/base64converter endpoint
